                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {team.roles.map((role, index) => (
                                        <span
                                            key={index}
                                            className="px-1.5 py-1.5 text-sm font-medium bg-background/50 text-foreground rounded-full border border-border/50 hover:bg-accent/10 hover:border-accent/20 transition-all duration-200"
                                        >
                                            {role}
                                        </span>
                                    ))}
