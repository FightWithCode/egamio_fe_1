  ...
  return (
    <ResponsiveContainer className="py-6">
      <div className="flex flex-col md:flex-row gap-4">
        {/* Sidebar */}
        <div className="w-full md:w-1/3 bg-background rounded-lg">
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex-1 grid grid-cols-3 gap-2">
                {mainNavItems.map((item) => (
                  <button
                    key={item.label}
                    className="flex flex-col items-center p-3 rounded-lg hover:bg-gray-700 text-foreground transition-colors group"
                  >
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <button
                      key={type}
                      className="w-full flex items-center justify-between px-4 py-2 rounded-lg hover:bg-gray-700 text-foreground transition-colors group"
                    >
                      <span>{type}</span>
